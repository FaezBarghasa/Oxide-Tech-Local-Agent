...
use qdrant_client::qdrant::{
    CreateCollectionBuilder, Distance, VectorParamsBuilder, SearchPoints,
};
...
impl<'a> DatasheetCollection<'a> {
    ...
    pub async fn setup_collection(&self) -> Result<(), anyhow::Error> {
        ...
        self.service.client.create_collection(
    ...
    pub async fn search_datasheets(
        ...
        let response = self.service.client.search_points(SearchPoints {
