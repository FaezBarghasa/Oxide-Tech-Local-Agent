...
export const CatalogTab: React.FC = () => {
  ...
  const [models, setModels] = useState<ModelInfo[]>([
    {
      id: 'local/DeepSeek-R1-0528-Qwen3-8B-Q4_K_M.gguf',
      name: 'DeepSeek R1 Qwen3 8B (Local GGUF)',
      fmt: 'GGUF',
      params: 8,
      tp: 1,
      vram: 5.2,
      dl: true,
      desc: 'Local GGUF in ~/models with deep chain-of-thought reasoning and math/code capabilities',
      tags: ['Local ~/models', 'GGUF Q4_K_M', 'Reasoning CoT', 'Active'],
    },
    {
      id: 'local/ornith-1.0-9b-Q4_K_M.gguf',
      name: 'Ornith 1.0 9B (Local GGUF)',
      fmt: 'GGUF',
      params: 9,
      tp: 1,
      vram: 5.8,
      dl: true,
      desc: 'Local GGUF in ~/models optimized for systems, embedded firmware, and KiCad DRC generation',
      tags: ['Local ~/models', 'GGUF Q4_K_M', 'Embedded & EDA', 'Active'],
    },
    {
      id: 'local/gemma4-v2-Q3_K_M.gguf',
      name: 'Gemma 4 v2 (Local GGUF Q3)',
      fmt: 'GGUF',
      params: 9,
      tp: 1,
      vram: 6.2,
      dl: true,
      desc: 'Local GGUF in ~/models for fast multi-modal context comprehension and code translation',
      tags: ['Local ~/models', 'GGUF Q3_K_M', 'Fast TTFT'],
    },
    {
      id: 'local/gemma-4-e2b-it.Q8_0.gguf',
      name: 'Gemma 4 e2b IT (Local GGUF Q8)',
      fmt: 'GGUF',
      params: 9,
      tp: 1,
      vram: 5.1,
      dl: true,
      desc: 'Local GGUF in ~/models with high-precision 8-bit quantization for deterministic verification',
      tags: ['Local ~/models', 'GGUF Q8_0', 'High Precision'],
    },
    {
      ...
      vram: 18.4,
      dl: true,
      desc: 'Primary base model for bare-metal embedded Rust & KiCad EDA synthesis',
      tags: ['QDoRA 4-bit', 'TP=2 Ready'],
    },
    {
